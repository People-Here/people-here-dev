...
public class RequestProperties {
	...
	private static final int PHONE_VERIFICATION_COUNT_LIMIT = 5; // 전화번호 인증 번호 전송 총 제한 횟수
	private static final int PHONE_VERIFICATION_TIME_LIMIT_DAY = 1; // 전화번호 인증 번호 전송 제한 시간
	private static final int PHONE_VERIFY_COUNT_LIMIT = 10; // 전화번호 인증 번호 검증 총 제한 횟수
	private static final int PHONE_VERIFY_TIME_LIMIT_DAY = 1; // 전화번호 인증 번호 전송 제한 시간
	...
	public static int getPhoneVerificationCountLimit() {
		return PHONE_VERIFICATION_COUNT_LIMIT;
	}

	public static int getPhoneVerificationTimeLimitDay() {
		return PHONE_VERIFICATION_TIME_LIMIT_DAY;
	}

	public static int getPhoneVerifyCountLimit() {
		return PHONE_VERIFY_COUNT_LIMIT;
	}

	public static int getPhoneVerifyTimeLimitDay() {
		return PHONE_VERIFY_TIME_LIMIT_DAY;
	}
