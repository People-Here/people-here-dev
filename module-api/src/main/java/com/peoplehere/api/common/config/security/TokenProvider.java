...
import static com.peoplehere.api.common.config.security.TokenType.*;
...
public class TokenProvider {
	...
	public Token generateToken(Authentication authentication) {
		return new Token(buildJwt(ACCESS, authentication), buildJwt(TokenType.REFRESH, authentication));
	}

	public String buildJwt(TokenType type, Authentication authentication) {
	...
	public Authentication getAuthenticationFromAcs(String token) {
		return getAuthentication(TokenType.ACCESS, token);
	}
